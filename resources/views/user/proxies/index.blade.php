...
@section('content')
    @include('user.proxies.actions.add-proxies')
    <div class="card">
        <div class="card-body">
                    ...
                    @foreach($datas as $data)
                        <tr>
                            ...
                            <td>
                                ...
                                @include('user.proxies.actions.edit-proxies')
                                @include('user.proxies.actions.delete-proxies')
                            </td>
                        </tr>
                    @endforeach
